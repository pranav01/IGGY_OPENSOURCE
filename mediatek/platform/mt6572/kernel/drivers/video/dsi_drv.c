...
/********************
*	edit by Magnum 2013-7-29: add for s7521 BOE-otm8018 ESD  
*	when take esd experiment ,lcd panel go bad ,but get the right id when read 
*	register0Ah
*	HSTX_CKLP_EN = 1:non-continuous mode
*	HSTX_CKLP_EN = 0:continuous mode
*************************/
#ifndef BUILD_LK
void Tinno_Open_Mipi_HS_Read()
{
	DSI_TXRX_CTRL_REG tmp_reg;  
   	tmp_reg=DSI_REG->DSI_TXRX_CTRL;
