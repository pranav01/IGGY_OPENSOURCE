...
void HI704_night_mode(kal_bool enable)
{
    ...
    SENSORDB("HI704_sensor.banding = %d\n",HI704_sensor.banding);
    spin_lock(&hi704_yuv_drv_lock);
    ...
    if(enable)
    {
        HI704_set_param_wb(AWB_MODE_AUTO);//Lock auto AWB in night mode.
        ...
        if(HI704_sensor.banding == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI704_write_cmos_sensor(0x83, 0x04);
            HI704_write_cmos_sensor(0x84, 0xf5);
            HI704_write_cmos_sensor(0x85, 0x88);
            HI704_write_cmos_sensor(0x86, 0x00);
            HI704_write_cmos_sensor(0x87, 0xfa);
       ...
       else 
       {
            ...
            HI704_write_cmos_sensor(0x83, 0x04);
            HI704_write_cmos_sensor(0x84, 0xf1);
            HI704_write_cmos_sensor(0x85, 0xa0);
            HI704_write_cmos_sensor(0x86, 0x00);
            HI704_write_cmos_sensor(0x87, 0xfa);
    ...
    else
    {
        ...
        if(HI704_sensor.banding == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI704_write_cmos_sensor(0x89, 0xf7);
            HI704_write_cmos_sensor(0x8a, 0xa0);
        ...
        else 
        {
            ...
            HI704_write_cmos_sensor(0x88, 0x04);
            HI704_write_cmos_sensor(0x89, 0x1e);
            HI704_write_cmos_sensor(0x8a, 0xb0);
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    SENSORDB("[Enter]HI704 set_param_wb func:HI704_sensor.wb = %d\n",HI704_sensor.wb);
    ...
    case AWB_MODE_AUTO:
        ...
        HI704_write_cmos_sensor(0x83, 0x5e);//0x5e
        HI704_write_cmos_sensor(0x84, 0x24);//0x24
        HI704_write_cmos_sensor(0x85, 0x5e);//0x5e
        HI704_write_cmos_sensor(0x86, 0x24);//0x24				
...
BOOL HI704_set_param_banding(UINT16 para)
{
    ...
    case AE_FLICKER_MODE_50HZ:
		...
		HI704_write_cmos_sensor(0x83,0x03);
		HI704_write_cmos_sensor(0x84,0xf7);
		HI704_write_cmos_sensor(0x85,0xa0);
		HI704_write_cmos_sensor(0x88,0x03);
		HI704_write_cmos_sensor(0x89,0xf7);
		HI704_write_cmos_sensor(0x8a,0xa0);
