...
void OV5645MIPIYUV_read_otp(void)
{
	int i;
...
*/
	...
	OV5645MIPI_write_cmos_sensor(0x5184, 0x25);//
	OV5645MIPI_write_cmos_sensor(0x5185, 0x24);//
	OV5645MIPI_write_cmos_sensor(0x5186, 0x0c);// 
	OV5645MIPI_write_cmos_sensor(0x5187, 0x15);//
	OV5645MIPI_write_cmos_sensor(0x5188, 0x0c);// 
...
/*	OV5645MIPI_write_cmos_sensor(0x5480, 0x01);//	; bias on
	...
	OV5645MIPI_write_cmos_sensor(0x5480, 0x01);//	; bias on
	OV5645MIPI_write_cmos_sensor(0x5481, 0x0e);//	; Y yst 00
	OV5645MIPI_write_cmos_sensor(0x5482, 0x1a);//
	OV5645MIPI_write_cmos_sensor(0x5483, 0x31);//
	OV5645MIPI_write_cmos_sensor(0x5484, 0x5a);//
	OV5645MIPI_write_cmos_sensor(0x5485, 0x69);//
	OV5645MIPI_write_cmos_sensor(0x5486, 0x75);//
	OV5645MIPI_write_cmos_sensor(0x5487, 0x7e);//
	OV5645MIPI_write_cmos_sensor(0x5488, 0x88);//
	OV5645MIPI_write_cmos_sensor(0x5489, 0x8f);//
	OV5645MIPI_write_cmos_sensor(0x548a, 0x96);//
	OV5645MIPI_write_cmos_sensor(0x548b, 0xa3);//
	OV5645MIPI_write_cmos_sensor(0x548c, 0xaf);//
	OV5645MIPI_write_cmos_sensor(0x548d, 0xc4);//
	OV5645MIPI_write_cmos_sensor(0x548e, 0xd7);//
	OV5645MIPI_write_cmos_sensor(0x548f, 0xe8);//
	OV5645MIPI_write_cmos_sensor(0x5490, 0x20);//

/*	OV5645MIPI_write_cmos_sensor(0x5480, 0x01);//	; bias on
	OV5645MIPI_write_cmos_sensor(0x5481, 0x0f);//	; Y yst 00
	OV5645MIPI_write_cmos_sensor(0x5482, 0x1e);//
	OV5645MIPI_write_cmos_sensor(0x5483, 0x3a);//
	OV5645MIPI_write_cmos_sensor(0x5484, 0x62);//
	OV5645MIPI_write_cmos_sensor(0x5485, 0x74);//
	OV5645MIPI_write_cmos_sensor(0x5486, 0x82);//
	OV5645MIPI_write_cmos_sensor(0x5487, 0x8e);//
	OV5645MIPI_write_cmos_sensor(0x5488, 0x98);//
	OV5645MIPI_write_cmos_sensor(0x5489, 0xa0);//
	OV5645MIPI_write_cmos_sensor(0x548a, 0xa7);//
	OV5645MIPI_write_cmos_sensor(0x548b, 0xb5);//
	OV5645MIPI_write_cmos_sensor(0x548c, 0xc0);//
	OV5645MIPI_write_cmos_sensor(0x548d, 0xd2);//
	OV5645MIPI_write_cmos_sensor(0x548e, 0xe1);//
	OV5645MIPI_write_cmos_sensor(0x548f, 0xed);//
	OV5645MIPI_write_cmos_sensor(0x5490, 0x19);//*/
#endif
#if 0
...
#else
	//From OV Kobe DNP for darling modules.
...
void OV5645MIPI_scene_mode_PORTRAIT()
{
	...
	OV5645MIPI_write_cmos_sensor(0x5382,0x55);//
	OV5645MIPI_write_cmos_sensor(0x5383,0x12);//
	OV5645MIPI_write_cmos_sensor(0x5384,0x23);//
	OV5645MIPI_write_cmos_sensor(0x5385,0x4b);//
	OV5645MIPI_write_cmos_sensor(0x5386,0x6f);//
	OV5645MIPI_write_cmos_sensor(0x5387,0x76);//
	OV5645MIPI_write_cmos_sensor(0x5388,0x9a);//
	OV5645MIPI_write_cmos_sensor(0x5389,0x25);//
	OV5645MIPI_write_cmos_sensor(0x538a,0x01);//
	OV5645MIPI_write_cmos_sensor(0x538b,0x98);//		                                             			 			 	 		 		 				 			 			 		 			 
	/*AE Weight - CenterAverage*/ 
...
void OV5645MIPI_scene_mode_SUNSET()
{
	...
	OV5645MIPI_write_cmos_sensor(0x3a15,0x88);
	/*ccm*/		
	OV5645MIPI_write_cmos_sensor(0x5381,0x42);//ccm
